...
def generator(data):
    ...
    face_casecade = cv2.CascadeClassifier(
        'C:\\Users\\Machenike\\Desktop\\my_project\\python-face\\haarcascade_frontalface_default.xml')
    # 打开摄像头
...
if __name__ == '__main__':
    data = 'C:\\Users\\Machenike\\Desktop\\my_project\\python-face'
    generator(data)
    FaceRec(data)